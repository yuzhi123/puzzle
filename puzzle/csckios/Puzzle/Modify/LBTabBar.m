...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self=[super initWithFrame:frame]) {
        ...
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"kk"] forState:UIControlStateNormal];
        [plusBtn setBackgroundImage:[UIImage imageNamed:@"kk"] forState:UIControlStateHighlighted];
        
        //给按钮添加投影
        plusBtn.layer.cornerRadius = 5;
        plusBtn.layer.shadowOffset =  CGSizeMake(0, 0);
...
- (void)layoutSubviews
{
    ...
    self.plusBtn.x = (WIDE-60)/2;
    //调整发布按钮的中线点Y值
    self.plusBtn.y = self.height * 0.5 - 5*LBMagin ;
