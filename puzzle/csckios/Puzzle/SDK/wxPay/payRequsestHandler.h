...
#define APP_ID          @"wx167fcbf7dd19751f"               //APPID
#define APP_SECRET      @"d7e6e4afcb64dc371519df62c42c6171" //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1262278501"
//商户API密钥，填写相应参数
#define PARTNER_ID      @"680cf115e52498bd219cdaa13c14f8ac"
//支付结果回调页面
